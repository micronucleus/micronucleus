...
## [`FAST_EXIT_NO_USB_MS`](https://github.com/ArminJo/micronucleus-firmware/blob/master/firmware/configuration/t85_fast_exit_on_no_USB/bootloaderconfig.h#L184) for fast bootloader exit
...
## [`ENTRY_POWER_ON`](https://github.com/ArminJo/micronucleus-firmware/blob/master/firmware/configuration/t85_entry_on_power_on/bootloaderconfig.h#L108) entry condition
...
## [`ENTRY_EXT_RESET`](https://github.com/ArminJo/micronucleus-firmware/blob/master/firmware/configuration/t85_entry_on_reset_no_pullup/bootloaderconfig.h#L122) entry condition
...
## [`START_WITHOUT_PULLUP`](https://github.com/ArminJo/micronucleus-firmware/blob/master/firmware/configuration/t85_entry_on_power_on_no_pullup_fast_exit_on_no_USB/bootloaderconfig.h#L207)
...
#### Pre built hex files for the basic configuration are already available in the [releases](/firmware/releases) and [upgrades](/firmware/upgrades) folders.
#### More pre built hex files for extended configurations are available in the [firmware / Arduino fork](https://github.com/ArminJo/micronucleus-firmware/tree/master/firmware/releases).
